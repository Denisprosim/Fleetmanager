...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Náklady</h1>
            ...
            <div class="modal fade" id="addExpenseModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="code.php" class="expense-form" method="POST">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="addExpenseBtn" class="btn btn-primary">Přidat</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="code.php" class="expense-form" method="POST">
                            <div class="modal-body">
                                <div class="form-group">
                                    <input type="hidden" name="id" id="vehicle-exp-id">
                                    <label>Vozidlo*</label>
                                ...
                                <div class="form-group">
                                    <label>Datum*</label>
                                    <input type="date" name="date" max="<?php echo date("Y-m-d"); ?>" id="expense-date" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Typ*</label>
                                    <select type="text" name="type" id="expense-type" class="form-control">
                                        <option value="Daně">Daně</option>
                                        <option value="Mýtné">Mýtné</option>
                                        <option value="Odpisy">Odpisy</option>
                                        <option value="Pojištění">Pojištění</option>
                                ...
                                <div class="form-group">
                                    <label>Info</label>
                                    <input type="text" name="info" id="expense-info" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Částka*</label>
                                    <input type="number" name="price" id="expense-price" class="form-control">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button class="btn btn-secondary" type="button" data-dismiss="modal">Zrušit</button>
                                <button type="submit" name="editExpenseBtn" class="btn btn-primary">Přidat</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="code.php" method="POST">
                            ...
                            <div class="modal-footer">
                                <button class="btn btn-secondary" type="button" data-dismiss="modal">Zrušit</button>
                                <button type="submit" name="deleteExpenseBtn" class="btn btn-primary">Odstranit</button>
                            </div>
                        </form>
                    </div>
                </div>
